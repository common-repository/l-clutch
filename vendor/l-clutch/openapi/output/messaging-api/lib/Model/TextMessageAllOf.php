...
/**
 * TextMessageAllOf Class Doc Comment
 *
 * @category Class
 * @package  LClutch\LineApi\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class TextMessageAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TextMessage_allOf';
    ...
    protected static $openAPITypes = [
        'text' => 'string',
        'emojis' => '\LClutch\LineApi\MessagingApi\Model\Emoji[]',
        'quote_token' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('quote_token', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets emojis
     *
     * @return \LClutch\LineApi\MessagingApi\Model\Emoji[]|null
     */
     ...
     * Sets emojis
     *
     * @param \LClutch\LineApi\MessagingApi\Model\Emoji[]|null $emojis emojis
     *
     * @return self
     */
     ...
     * Sets quote_token
     *
     * @param string|null $quote_token Quote token of the message you want to quote.
     *
     * @return self
     */
    public function setQuoteToken($quote_token)
    {
        if (is_null($quote_token)) {
            throw new \InvalidArgumentException('non-nullable quote_token cannot be null');
        }
