...
/**
 * TestWebhookEndpointRequest Class Doc Comment
 *
 * @category Class
 * @package  LClutch\LineApi\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class TestWebhookEndpointRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TestWebhookEndpointRequest';
    ...
    */
     ...
     * Sets endpoint
     *
     * @param string|null $endpoint A webhook URL to be validated.
     *
     * @return self
     */
    public function setEndpoint($endpoint)
    {
        ...
        if ((mb_strlen($endpoint) > 500)) {
            throw new \InvalidArgumentException('invalid length for $endpoint when calling TestWebhookEndpointRequest., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($endpoint) < 0)) {
            throw new \InvalidArgumentException('invalid length for $endpoint when calling TestWebhookEndpointRequest., must be bigger than or equal to 0.');
        }
