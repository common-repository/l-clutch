...
class RichMenuRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['chat_bar_text']) && (mb_strlen($this->container['chat_bar_text']) > 14)) {
     ...
     * Gets size
     *
     * @return \LClutch\LineApi\MessagingApi\Model\RichMenuSize|null
     */
     ...
     * Sets size
     *
     * @param \LClutch\LineApi\MessagingApi\Model\RichMenuSize|null $size size
     *
     * @return self
     */
     ...
     * Sets chat_bar_text
     *
     * @param string|null $chat_bar_text Text displayed in the chat bar
     *
     * @return self
     */
    public function setChatBarText($chat_bar_text)
    {
        ...
        if ((mb_strlen($chat_bar_text) > 14)) {
            throw new \InvalidArgumentException('invalid length for $chat_bar_text when calling RichMenuRequest., must be smaller than or equal to 14.');
        }
     ...
     * Gets areas
     *
     * @return \LClutch\LineApi\MessagingApi\Model\RichMenuArea[]|null
     */
     ...
     * Sets areas
     *
     * @param \LClutch\LineApi\MessagingApi\Model\RichMenuArea[]|null $areas Array of area objects which define the coordinates and size of tappable areas
     *
     * @return self
     */
