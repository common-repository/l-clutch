...
/**
 * FlexBlockStyle Class Doc Comment
 *
 * @category Class
 * @package  LClutch\LineApi\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class FlexBlockStyle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlexBlockStyle';
    ...
    protected static $setters = [
        ...
        'separator_color' => 'setSeparatorColor'
    ];
    ...
    protected static $getters = [
        ...
        'separator_color' => 'getSeparatorColor'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('separator_color', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets separator
     *
     * @param bool|null $separator separator
     *
     * @return self
     */
    ...
    /**
     * Gets separator_color
     *
     * @return string|null
     */
    public function getSeparatorColor()
    {
        return $this->container['separator_color'];
    }

    /**
     * Sets separator_color
     *
     * @param string|null $separator_color separator_color
     *
     * @return self
     */
    public function setSeparatorColor($separator_color)
    {
        if (is_null($separator_color)) {
            throw new \InvalidArgumentException('non-nullable separator_color cannot be null');
        }
        $this->container['separator_color'] = $separator_color;
