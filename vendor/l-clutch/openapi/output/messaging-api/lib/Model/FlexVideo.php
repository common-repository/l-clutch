...
class FlexVideo extends FlexComponent
{
    ...
    protected static $openAPITypes = [
        'url' => 'string',
        'preview_url' => 'string',
        'alt_content' => '\LClutch\LineApi\MessagingApi\Model\FlexComponent',
        'aspect_ratio' => 'string',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['alt_content'] === null) {
            $invalidProperties[] = "'alt_content' can't be null";
        }
     ...
     * Sets alt_content
     *
     * @param \LClutch\LineApi\MessagingApi\Model\FlexComponent $alt_content alt_content
     *
     * @return self
     */
