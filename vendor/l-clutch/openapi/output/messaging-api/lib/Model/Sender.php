...
class Sender implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['icon_url']) && (mb_strlen($this->container['icon_url']) > 2000)) {
            $invalidProperties[] = "invalid value for 'icon_url', the character length must be smaller than or equal to 2000.";
        }
     ...
     * Sets name
     *
     * @param string|null $name Display name. Certain words such as `LINE` may not be used.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 20)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Sender., must be smaller than or equal to 20.');
        }
     ...
     * Sets icon_url
     *
     * @param string|null $icon_url URL of the image to display as an icon when sending a message
     *
     * @return self
     */
    public function setIconUrl($icon_url)
    {
        ...
        if ((mb_strlen($icon_url) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $icon_url when calling Sender., must be smaller than or equal to 2000.');
        }
