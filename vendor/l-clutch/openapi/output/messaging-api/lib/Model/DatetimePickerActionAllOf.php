...
/**
 * DatetimePickerActionAllOf Class Doc Comment
 *
 * @category Class
 * @package  LClutch\LineApi\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class DatetimePickerActionAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DatetimePickerAction_allOf';
    ...
    */
    ...
    public function setData($data)
    {
        ...
        if ((mb_strlen($data) > 300)) {
            throw new \InvalidArgumentException('invalid length for $data when calling DatetimePickerActionAllOf., must be smaller than or equal to 300.');
        }
        if ((mb_strlen($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling DatetimePickerActionAllOf., must be bigger than or equal to 0.');
        }
