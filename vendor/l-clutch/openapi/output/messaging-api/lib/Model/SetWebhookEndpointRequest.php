 ...
 */
class SetWebhookEndpointRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetWebhookEndpointRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['endpoint']) < 0)) {
     ...
     * Sets endpoint
     *
     * @param string $endpoint A valid webhook URL.
     *
     * @return self
     */
    public function setEndpoint($endpoint)
    {
        ...
        if ((mb_strlen($endpoint) > 500)) {
            throw new \InvalidArgumentException('invalid length for $endpoint when calling SetWebhookEndpointRequest., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($endpoint) < 0)) {
            throw new \InvalidArgumentException('invalid length for $endpoint when calling SetWebhookEndpointRequest., must be bigger than or equal to 0.');
        }
