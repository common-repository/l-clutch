...
/**
 * GroupUserProfileResponse Class Doc Comment
 *
 * @category Class
 * @package  LClutch\LineApi\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class GroupUserProfileResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupUserProfileResponse';
    ...
    */
     ...
     * Sets picture_url
     *
     * @param string|null $picture_url Profile image URL. `https` image URL. Not included in the response if the user doesn't have a profile image.
     *
     * @return self
     */
