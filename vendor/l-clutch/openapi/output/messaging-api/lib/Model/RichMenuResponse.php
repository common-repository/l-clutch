...
class RichMenuResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'rich_menu_id' => 'string',
        'size' => '\LClutch\LineApi\MessagingApi\Model\RichMenuSize',
        'selected' => 'bool',
        'name' => 'string',
        'chat_bar_text' => 'string',
        'areas' => '\LClutch\LineApi\MessagingApi\Model\RichMenuArea[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('chat_bar_text', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['chat_bar_text'] === null) {
            $invalidProperties[] = "'chat_bar_text' can't be null";
        }
        if ((mb_strlen($this->container['chat_bar_text']) > 14)) {
            $invalidProperties[] = "invalid value for 'chat_bar_text', the character length must be smaller than or equal to 14.";
        }
     ...
     * Sets rich_menu_id
     *
     * @param string $rich_menu_id ID of a rich menu
     *
     * @return self
     */
     ...
     * Gets size
     *
     * @return \LClutch\LineApi\MessagingApi\Model\RichMenuSize
     */
     ...
     * Sets size
     *
     * @param \LClutch\LineApi\MessagingApi\Model\RichMenuSize $size size
     *
     * @return self
     */
    ...
    {
        return $this->container['chat_bar_text'];
    }

    /**
     * Sets chat_bar_text
     *
     * @param string $chat_bar_text Text displayed in the chat bar
     *
     * @return self
     */
    public function setChatBarText($chat_bar_text)
    {
        if (is_null($chat_bar_text)) {
            throw new \InvalidArgumentException('non-nullable chat_bar_text cannot be null');
        }
        if ((mb_strlen($chat_bar_text) > 14)) {
            throw new \InvalidArgumentException('invalid length for $chat_bar_text when calling RichMenuResponse., must be smaller than or equal to 14.');
        }

        $this->container['chat_bar_text'] = $chat_bar_text;
     ...
     * Gets areas
     *
     * @return \LClutch\LineApi\MessagingApi\Model\RichMenuArea[]
     */
     ...
     * Sets areas
     *
     * @param \LClutch\LineApi\MessagingApi\Model\RichMenuArea[] $areas Array of area objects which define the coordinates and size of tappable areas
     *
     * @return self
     */
