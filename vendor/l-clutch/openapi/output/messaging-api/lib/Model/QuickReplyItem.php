...
class QuickReplyItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets image_url
     *
     * @param string|null $image_url URL of the icon that is displayed at the beginning of the button
     *
     * @return self
     */
    public function setImageUrl($image_url)
    {
        ...
        if ((mb_strlen($image_url) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling QuickReplyItem., must be smaller than or equal to 2000.');
        }
