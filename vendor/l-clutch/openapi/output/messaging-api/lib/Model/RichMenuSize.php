...
/**
 * RichMenuSize Class Doc Comment
 *
 * @category Class
 ...
 */
class RichMenuSize implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RichMenuSize';
    ...
    */
    ...
    public function setWidth($width)
    {
        ...
        if (($width > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $width when calling RichMenuSize., must be smaller than or equal to 2147483647.');
        }
        if (($width < 1)) {
            throw new \InvalidArgumentException('invalid value for $width when calling RichMenuSize., must be bigger than or equal to 1.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (($height > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $height when calling RichMenuSize., must be smaller than or equal to 2147483647.');
        }
        if (($height < 1)) {
            throw new \InvalidArgumentException('invalid value for $height when calling RichMenuSize., must be bigger than or equal to 1.');
        }
