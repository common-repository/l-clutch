...
/**
 * GroupSummaryResponse Class Doc Comment
 *
 * @category Class
 * @package  LClutch\LineApi\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class GroupSummaryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupSummaryResponse';
    ...
    */
     ...
     * Sets picture_url
     *
     * @param string|null $picture_url Group icon URL. Not included in the response if the user doesn't set a group profile icon.
     *
     * @return self
     */
