...
class IssueShortLivedChannelAccessTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets access_token
     *
     * @param string $access_token A short-lived channel access token. Valid for 30 days. Note: Channel access tokens cannot be refreshed.
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int $expires_in Time until channel access token expires in seconds from time the token is issued.
     *
     * @return self
     */
