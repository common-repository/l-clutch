...
namespace LClutch\LineApi\ChannelAccessToken\Model;
...
class IssueStatelessChannelAccessTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets access_token
     *
     * @param string $access_token A stateless channel access token. The token is an opaque string which means its format is an implementation detail and the consumer of this token should never try to use the data parsed from the token.
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int $expires_in Duration in seconds after which the issued access token expires
     *
     * @return self
     */
     ...
     * Sets token_type
     *
     * @param string $token_type Token type. The value is always `Bearer`.
     *
     * @return self
     */
