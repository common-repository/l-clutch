 ...
 */
class VerifyChannelAccessTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerifyChannelAccessTokenResponse';
    ...
    */
     ...
     * Sets client_id
     *
     * @param string $client_id The channel ID for which the channel access token was issued.
     *
     * @return self
     */
     ...
     * Sets scope
     *
     * @param string|null $scope Permissions granted to the channel access token.
     *
     * @return self
     */
