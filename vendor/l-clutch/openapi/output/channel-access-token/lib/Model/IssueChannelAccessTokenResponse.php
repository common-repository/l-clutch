...
class IssueChannelAccessTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets expires_in
     *
     * @param int $expires_in Amount of time in seconds from issue to expiration of the channel access token
     *
     * @return self
     */
     ...
     * Sets token_type
     *
     * @param string $token_type A token type.
     *
     * @return self
     */
     ...
     * Sets key_id
     *
     * @param string $key_id Unique key ID for identifying the channel access token.
     *
     * @return self
     */
